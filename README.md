...
<p align="center">
  <a href="https://wa.me/+923153637458?text=Hi+Bro--+I+Need+Help.+I+messaged+you+from+Suhail-Md+Repo" target="_blank">
...
- If any problem, then [`+923163298247`](https://wa.me/923163298247)
...
The SATTAR_Md is made available under the [GPL-3 license](https://github.com/SuhailTechInfo/Suhail-Md/blob/main/LICENCE).
...
## 
- *SATTAR-Md is not made by `WhatsApp Inc.` Sometimes or misusing the bot might `ban` your `WhatsApp account!`*
