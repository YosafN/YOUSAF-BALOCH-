 <h1 align="center"> YOUSAF BALOCH</h1> 
<p align="center"> A simple WhatsApp bot with rich features. </p>

 
<h3 align="center"> <a href="https://github.com/YosafN/YOUSAF-BALOCH-Media">🍫 EXTERNAL PLUGINS 🍫</a></h3> 
...
<p align="center">
   <a href="https://github.com/YosafN/YOUSAF-BALOCH/fork">
    <img src="https://img.shields.io/github/forks/SuhailTechInfo/Suhail-Md?style=flat-square&logo=github&color=darkred">
   </a>
  <a href="https://github.com/YosafN/YOUSAF-BALOCHstargazers"> 
     <img src="https://img.shields.io/github/stars/SuhailTechInfo/Suhail-Md?style=flat-square&logo=github&color=darkred">
 </a>



  <a aria-label="Suhail_Md is free to use" href="https://youtube.com/@Y.BGamer110" target="_blank">
    <img alt="SuhailTechInfo Yt" src="https://img.shields.io/youtube/channel/subscribers/UCU071AMRqcd5mfTdCgJFwPg" target="_blank" />
  </a>

</p>
<p align="center"><img src="https://profile-counter.glitch.me/{SuhailTechInfo}/count.svg" alt="YOUSAF BALOCH:: Visitor's Count" /></p>

<p align="center">

 <a href="https://github.com/YosafN/YOUSAF-BALOCH">
...
<p align="center"> YOUSAF BALOCH whatsapp bot uses
...
## Deployment Methods
---
1.  ***Get `SESSION ID` by [`SCANING QR`](https://yousaf-md-vtsf.onrender.com/) Or [`PARING CODE`](https://yousaf-md-vtsf.onrender.com/code). Then `Go-to Whatapp>Three dots>Linked Devices`***
2.  ***Get Mongodb_URI from [`Mongodb site`](https://www.mongodb.com/) | Watch Tutorial [`To Get Mongodb_URI`](https://youtube.com/@Y.BGamer110). `Optional`***
3.  ***Click [`FORK`](https://github.com/YosafN/YOUSAF-BALOCH/fork) and `Star ⭐ Repository` for Courage.***
4.  ***Deploy FREE on `Codespace,` First watch tutorial [`Codespace tutorial`](https://youtube.com/@Y.BGamer110)***
...
- If any problem, then create an [`+issue`](https://github.com/YosafN/YOUSAF-BALOCH/issues/new) Or ask anything here [`+Q&A`](https://github.com/YosafN/YOUSAF-BALOCH/discussions/new?category=q-a)!
