...
global.timezone  = process.env.TIME_ZONE || 'Harare/Africa'
global.gurl = 'https://www.youtube.com/@keketsoovpnsettings' ; // add your username
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : '263714906216'; ;
global.devs = "923184474176"; //Dont change it From here
global.github  = process.env.YOUR_GITHUB || 'https://github.com/Kenala16/Suhail-Md.git';
global.scan  = process.env.QR_URL || 'https://replit.com/@SuhailTechInfo/Suhail-Md?v=1';
global.website = 'https://github.com/Kenala16/Suhail-Md.git' ; //wa.me/+923000000000
...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER || 'ᴋᴇɴᴅʀɪᴄᴋ',
  errorChat : process.env.ERROR_CHAT|| '', // put 'chat' here to send error in chat ,where it accures
  read_status : process.env.AUTO_READ_STATUS || 'false',
  save_status : process.env.AUTO_SAVE_STATUS || 'false',
  packname:  process.env.PACK_NAME || "\t   𓅋 ᴋᴇɴᴅʀɪᴄᴋ \n\nᴋɪss ʍᴇ...💋\n\nᴄʟօsᴇ ყσυɾ ᴇყᴇs...👁️🙈\n\nʍɪss ʍᴇ...♥️\n\n\n   -ᴘʟᴇᴀsᴇ ᴅᴏɴ'ᴛ ᴛᴀӄᴇ 🚮 \n\n--- ρυвʟɪᴄ вσт нᴇʀᴇ ---" ,
  ...
  caption :process.env.CAPTION || "```ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋᴇɴᴅʀɪᴄᴋ```",   //*『sᴜʙsᴄʀɪʙᴇ • ᴋᴇᴋᴇᴛsᴏ』*\youtube.com/@keketsoovpnsettings"),
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'' ,
  VERSION: process.env.VERSION || 'v.1.2.2',
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : 'ᴋᴇɴᴅʀɪᴄᴋ',
