...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '13474994916';
...
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : '13474994916'; ;
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'Aneesha',
  ...
  caption :process.env.CAPTION || "```Powered By Aneesha```",   //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'' ,
  VERSION: process.env.VERSION || 'v.1.2.2',
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : 'Aneesha',
