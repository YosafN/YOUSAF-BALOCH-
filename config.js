...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '94741191182';
...
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : '94741191182'; ;
global.devs = "94741191182"; //Dont change it From here
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'Chanu-ᴍᴅ',
  botbgm: process.env.BOT_BGM || 'false',
  ownername:  process.env.OWNER_NAME || `It'x Chanu`,
  ...
  antilink_values: process.env.ANTILINK_VALUES || 'https://,chat.whatsapp.com''sex''xxx',
  ...
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : 'ChAnU',
