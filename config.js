...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '923191031395';
...
module.exports = {
  sessionName: process.env.SESSION_ID || "Suhail;;;SurfingHarley",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'Zeeshan Raju',
  botbgm: process.env.BOT_BGM || 'false',
  ownername:  process.env.OWNER_NAME || `It'x Zeeshan`,
