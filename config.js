...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '254796861806';
...
global.email = 'vawulatorag@gmail.com' ;
global.location = 'KENYA JUJA' ;
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://images.app.goo.gl/ysYkREPq1x75bqMv6' ;
module.exports = {
  sessionName: process.env.SESSION_ID || "",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'VAWULATOR AG',
  botbgm: process.env.BOT_BGM || 'true',
  ownername:  process.env.OWNER_NAME || `NIETO`,
  author:  process.env.PACK_AUTHER || 'AG',
  ...
  caption :process.env.CAPTION || "VAWULATOR AG",   //*『sᴜʙsᴄʀɪʙᴇ • VAWULATOR AG』*\n youtube.com/@VAWULATOR AG"),
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'' ,
  VERSION: process.env.VERSION || 'v.1.2.2',
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : 'VAWULATOR',
